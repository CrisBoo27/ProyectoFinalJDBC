...
import java.sql.SQLException; //Para manejo de errores
...
import java.sql.PreparedStatement; // para manejo de sentencias
import java.sql.ResultSet;
import java.util.logging.Level; // sentencias preparadas 
...
public class Empleado extends javax.swing.JFrame {
    ...
    public void getEmpleado (int id_empleado){
  try{
          //ES MI SENTENCIA O EL QRY QUE VOY A EJECUTAR PARA ELIMINAR REGISTROS
          String qry = "select id_empleado, nombre,apellido,salario from public.empleado where id_empleado =?";
          
          //Espacio de trabajo que lleva la conexion para escribir sentencias QRY
    ...
    public void guardarEmpleadoPS(){
        try{
          ...
          int filasInsertadas = ps.executeUpdate(); // EJECUTA LA SENTENCIA A LA BASE DE DATOS LA CUAL RETORNA UN INT
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try{
          ...
          //El panel o cuadro de dialogo donde me solicita el codigo a eliminar
          String id_empleado = JOptionPane.showInputDialog("Ingrese el codigo que desea eliminar");
